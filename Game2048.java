...
public class Game2048 extends Game {
    ...
    private void win() {
        isGameStopped = true;
        showMessageDialog(Color.GRAY, "Winner Winner, Chicken Diner!", Color.BLUE, 10);
    }
    private void gameOver() {
        isGameStopped = true;
        showMessageDialog(Color.GRAY, "You lost, but you're still a winner! Or are you?", Color.BLUE,10);
    }
